  ...
  sortOrder: ({ ...props }: LucideProps) => {
    ...
    return (
      <svg
        ...
        focusable="false"
        role="img"
        className={cn('w-2 text-gray-950', props.className)}
      >
        <motion.path
          className={cn(!props.order && 'opacity-40')}
          animate={{ d: props.order === 'asc' ? downPath : upPath }}
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
        ...
        <motion.path
          ...
          animate={{ d: props.order === 'asc' ? upPath : downPath }}
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
